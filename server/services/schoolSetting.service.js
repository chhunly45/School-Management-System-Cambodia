...
const normalizeSettingsPayload = (payload = {}, { partial = false } = {}) => {
  const next = {
    ...
    morningCheckInStart: payload.morningCheckInStart === undefined ? null : (String(payload.morningCheckInStart || '').trim() || null),
    morningCheckInEnd: payload.morningCheckInEnd === undefined ? null : (String(payload.morningCheckInEnd || '').trim() || null),
    afternoonCheckInStart: payload.afternoonCheckInStart === undefined ? null : (String(payload.afternoonCheckInStart || '').trim() || null),
    afternoonCheckInEnd: payload.afternoonCheckInEnd === undefined ? null : (String(payload.afternoonCheckInEnd || '').trim() || null),
    eveningCheckInStart: payload.eveningCheckInStart === undefined ? null : (String(payload.eveningCheckInStart || '').trim() || null),
    eveningCheckInEnd: payload.eveningCheckInEnd === undefined ? null : (String(payload.eveningCheckInEnd || '').trim() || null),
