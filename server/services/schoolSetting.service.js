...
const normalizeSettingsPayload = (payload = {}, { partial = false } = {}) => {
  const next = {
    ...
    morningCheckInStart: payload.morningCheckInStart === undefined ? '06:45' : (String(payload.morningCheckInStart || '').trim() || '06:45'),
    morningCheckInEnd: payload.morningCheckInEnd === undefined ? '10:45' : (String(payload.morningCheckInEnd || '').trim() || '10:45'),
    afternoonCheckInStart: payload.afternoonCheckInStart === undefined ? '12:30' : (String(payload.afternoonCheckInStart || '').trim() || '12:30'),
    afternoonCheckInEnd: payload.afternoonCheckInEnd === undefined ? '16:00' : (String(payload.afternoonCheckInEnd || '').trim() || '16:00'),
    eveningCheckInStart: payload.eveningCheckInStart === undefined ? '18:00' : (String(payload.eveningCheckInStart || '').trim() || '18:00'),
    eveningCheckInEnd: payload.eveningCheckInEnd === undefined ? '20:00' : (String(payload.eveningCheckInEnd || '').trim() || '20:00'),
