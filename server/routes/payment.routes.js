...
router.get(
  ...
  query('paymentType').optional().isIn(['monthly', 'quarterly', 'semi-annual', 'yearly']),
  query('paymentPlan').optional().isIn(['monthly', 'quarterly', 'semi-annual', 'yearly']),
...
router.post(
  ...
  body('paymentType').optional().isIn(['monthly', 'quarterly', 'semi-annual', 'yearly']),
  body('paymentPlan').optional().isIn(['monthly', 'quarterly', 'semi-annual', 'yearly']),
